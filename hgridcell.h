...
class GRIDCTRL_EXPORT HGridCell : public HGridCellBase
{
    Q_OBJECT
public:
...
public:
    ...
    virtual void  setData(const quint32& var)               { m_lParam = var;      } //设置数据
    ...
    virtual quint32     data()    const                     { return m_lParam;  }
